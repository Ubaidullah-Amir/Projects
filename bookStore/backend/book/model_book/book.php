...
class Book{
    ...
    public function read(){
        ...
        where g.genre_id=b.genre_id AND p.publisher_id=b.publisher_id';
...
//read by title
        ...
        //create queary
        $query='SELECT * FROM book WHERE title=:title AND edition=:edition LIMIT 0,1';
    ...
    public function read_genre(){
        //create queary
        $query='SELECT b.*,g.name AS genre_name,p.name AS publisher_name FROM book b,genre g,publisher p 
        where g.genre_id=b.genre_id AND p.publisher_id=b.publisher_id AND g.genre_id=:genre_id';
